...
ADMIN_UID = "1457057808"
GUEST_UID = "4684636266"
GUEST_PASSWORD = "B687FC78FC7F2D4816533090927BDBB541BC621BBE9992E8E9F671C788BF9A33"
region = 'IN'
...
[CCFFCC]━━━━━━━━━━━━━━━━━━━━━━━━━━
[B][C][81DACA]P O W E R E D   B Y  S V X B M
[FFFF00]━━━━━━━━━━━━━━━━━━━━━━━━━━
            ...
            while True:
                ...
                if data_hex.startswith("0500") and insquad is None and joining_team == False:
                    try:
                        ...
                        insquad = True
                        try:
                            welcome_message = """[B][C][FFFFFF]Welcome to SVX BM Bot
...
[B][C][FFFFFF]Telegram : @svxbm69
[B][C][FFFFFF]Contact : @itethan2012
...
[B][C][FFFFFF]Status: Online & Active"""
                ...
                if data2.hex().startswith('0500') and len(data2.hex()) > 1000:
                    try:
                        ...
                        message = """[B][C][FFFFFF]Welcome to SVX BM Bot
...
"""
                        ...
                        if inPuTMsG.strip() == '/stop evo_c':
                            if evo_custom_spam_task and not evo_custom_spam_task.done():
                                ...
                                await dl_send_message(response.Data.chat_type, error_msg, uid, chat_id, key, iv)
                        if inPuTMsG.strip().lower() == "SVXBM bhai mera uid do":
